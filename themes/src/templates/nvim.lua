...
hl("@markup.italic.markdown_inline", { link = "Keyword", italic = true })
...
hl("@markup.strong.markdown_inline", { link = "Keyword", bold = true })
...
hl("NvimTreeGitStagedIcon", { fg = "{{sidebar.changed}}" })
...
-- GitSigns
hl("GitSignsAdd", { fg = "{{gutter.added}}" })
hl("GitSignsChange", { fg = "{{gutter.changed}}" })
hl("GitSignsDelete", { fg = "{{gutter.deleted}}" })
